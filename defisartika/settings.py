"""
Django settings for defisartika project.
...
SECRET_KEY = 'goy(_+@4_z^k8)k^k(!d$u72a5$f&#og8alu97jkp_f!y=0w#i'
...
WSGI_APPLICATION = 'defisartika.wsgi.application'
